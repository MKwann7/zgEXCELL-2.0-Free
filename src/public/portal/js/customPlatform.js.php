<?php
?>
if (typeof customPlatformManager !== "function")
{
    customPlatformManager = function()
    {
        const load = function(platformId, elmId)
        {
            sendAjax("<?php echo getFullUrl(); ?>/platforms/get-custom-platform-manager-component?id=" + platformId, {}, function (result)
            {
