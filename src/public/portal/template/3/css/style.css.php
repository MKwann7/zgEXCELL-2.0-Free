...
$portalThemeSecondaryColor = $this->app->objCustomPlatform->getCompanySettings()->FindEntityByValue("label","portal_theme_secondary_color")->value ?? $portalThemeMainColor;
...
#dropdownMenuButton .quick-action-title {
    font-family: 'Roboto Condensed', sans-serif;
}
.nav-box-card > h5 {
    font-family: 'Roboto Condensed', sans-serif;
...
.nav-box-card > h5 > span:first-child {
    font-size: 21px;
    top: 3px;
    position: relative;
}
.nav-box-card > h5 .fa-caret-left {
    position: absolute;
    top: 6px;
    right: 0;
}
.nav-box-card > h5.pinnedMenuItemOuter .fa-caret-left:before {
    content: "\f0d7";
}
.nav-box-card  li {
    position: relative;
}
.nav-box-card li .pin-item {
    position:absolute;
    top:15px;
    right:5px;
    visibility: hidden;
...
.nav-box-card li:hover .pin-item {
...
.nav-box-card li .pin-item.pinnedMenuItem {
    font-family: "Font Awesome 5 Free";
    content: "\f08d";
    visibility: visible;
...
.theme_shade_light .nav-dashboard .btn-primary.quick-actions:hover,
.theme_shade_light .nav-dashboard .btn-primary.quick-actions:active,
.theme_shade_light .nav-dashboard .btn-primary.quick-actions {
    background: white;
    color: #<?php echo $portalThemeSecondaryColor; ?> !important;
}
...
.breadCrumbsInner .sub-page-link {
    padding: 2px 12px;
    border-radius: 5px 5px 0 0;
}
.breadCrumbsInner .sub-page-link:hover {
    padding: 0 12px 0;
    border-radius: 5px 5px 0 0;
}
body.theme_shade_light .breadCrumbsInner li.sub-page-link {
    box-sizing: content-box;
    position: relative;
    top: 13px;
    left: 11px;
}
body.theme_shade_light .breadCrumbsInner li.sub-page-link a {
    font-size:16px;
}
body.theme_shade_light .breadCrumbsInner li.sub-page-link.activeSubPage  {
    border-bottom:2px solid #0000ff;
}
.breadCrumbsInner .sub-page-link a {
    text-decoration: none;
}
body.theme_shade_light .breadCrumbsInner li.sub-page-link.activeSubPage a {
...
.right-float-menu-outer .fa-shopping-cart {
    font-size:19px;
    position: relative;
    top: 4px;
}
...
.entityDashboard .account-page-title {
    border-radius:5px;
    padding:5px 7px 7px;
    color:#fff !important;
    background: #<?php echo $portalThemeMainColor; ?> !important;
    top:1px;
    font-size:1.5rem;
    width: calc(100% - 15px);
}
.entityDashboard .account-page-title .back-to-entity-list {
    color:#fff !important;
    top:3px;
