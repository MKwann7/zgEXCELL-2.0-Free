/*
 * Slim v4.5.1 - Image Cropping Made Easy
...
// Find which vendor prefix to use
            ...
            var snabbt = function(arg1, arg2, arg3, test) {
...
// Loop through and start one animation for each element.
                if(elements.length !== undefined) {
                    ...
                    for(var i=0, len=elements.length;i<len;++i) {
                        if (typeof arg2 == 'string') {
                            aggregateChainer.chainers.push(snabbtSingleElement(elements[i], arg2, preprocessOptions(arg3, i, len, test)));
                        } else {
                            aggregateChainer.chainers.push(snabbtSingleElement(elements[i], preprocessOptions(arg2, i, len, test), arg3));
                        }
                    }
                    return aggregateChainer;
                } else {
            ...
            var preprocessOptions = function(options, index, len, test) {
                if(!options)
                    return options;
...
// pointer events
        ...
        var ImageExtensionsRegex = /(\.png|\.bmp|\.gif|\.jpg|\.jpe|\.jpg|\.jpeg|\.ico)$/;
...
// events
        ...
        var SlimButtons = ['remove', 'edit', 'upload', 'browse'];
        ...
        var Slim = function () {
            function Slim(element, options, callbackSave, callbackRemove) {
                ...
                if (callbackSave) {
                    this._callbackSave = callbackSave;
                }
            ...
            _createClass(Slim, [{
                    ...
                    if (this._options.service && allowUpload) {
                        this._options.willSave.apply(this, [data, function (data) {
                            ...
                            _this24._upload(data, function (err, res) {
                                ...
                                if (typeof _this24._callbackSave !== "undefined") {
                                    _this24._callbackSave.app[_this24._callbackSave.method](res.data);
                                }
                ...
                key: '_hideButtons',
                value: function _hideButtons(callback, test) {
                    var _this26 = this;
                    ...
                    // go hide the buttons
                    snabbt(this._btnGroup.childNodes, animation, null, test);
                }
            }, {
                key: '_hideStatus',
                ...
                value: function _doRemove() {
                    ...
                    if (typeof this._callbackRemove !== "undefined") {
                        this._callbackRemove.app[this._callbackRemove.method]();
                    }
                ...
                value: function options() {
                    ...
                    var defaults = {
                        ...
                        label: '<p>Click Here to Add an Image</p><p>or Drag and Drop an Image Here</p>',
        ...
        (function () {
            ...
            Slim.getOptionsFromAttributes = function (element, other) {
                ...
                if (other) {
                    for (let currOption in other) {
                        options[currOption] = other[currOption];
                    }
                }
            ...
            Slim.setUploadUrl = function (element, url) {
                var result = instances.filter(function (instance) {
                    return instance.isAttachedTo(element);
                });

                result[0]._options.service = url;

                return true;
            };

            Slim.create = function (element, options, callbackSave, callbackRemove) {
                ...
                // instance
                var slim = new Slim(element, options, callbackSave, callbackRemove);
            ...
            Slim.save = function (element, callback) {
                ...
                instances[index]._doUpload(callback);
