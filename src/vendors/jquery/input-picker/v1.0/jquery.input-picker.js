...
(function(factory) {
            ...
            return this.each(function () {
                ...
                }
                {
                    ...
                    input.data('inputpicker-original', original)
                        .prop('autocomplete', 'nope-' + randomIntFromInterval(1000,9999));
    ...
    function _renderTableHeader(input) {
        ...
        if(_set(input, 'headShow')){
            output += '<div class="divHeader"><div class="divRow">';
            for(var i = 0; i < fields.length; i++){
                ...
                output += '<div class="divRow">' + text + '</div class="divRow">';
            }
            output += '</div>';
        }
        return output;
    ...
    function _renderPaginationFooter(input){
        ...
        if( fields.length > 0 && _pagination(input)){
            var fields = _set(input, 'fields');
            output += '<div class="divFooter inputpicker-pagination"><div class="divRow"><div class="divCell" align="right" colspan="' + fields.length + '">';
    ...
    function _dataRenderMultiple(input){
        ...
        // Draw table
        output += "<div class=\"divTable small\">" ;
        ...
        // Show data
        if(data.length){
            output += "<div class=\"divTBody\">" ;
            var isSelected = false;
            for(var i = 0; i < data.length; i++) {
                isSelected =  -1 < _inArray( data[i][fieldValue] , arr_value );
                output += '<div class="divRow inputpicker-element inputpicker-element-' + i + ' ' + (isSelected ? 'inputpicker-selected' : '') + ' " data-i="' + i + '" data-value="' + data[i][fieldValue] + '">';
            ...
            output += "<div class='divHeader'><div class='divRow'><div class='divCell' class=\"inputpicker-no-result\">No results.</div></div></div>";
        }
        ...
        // Set events
        wrapped_list.find('div.divTBody').find('div.divRow').each(function () {
            var that = $(this);
    ...
    function _dataRenderDefault(input) {
        ...
        if(data.length){
            ...
            for(var i = 0; i < data.length; i++) {
                ...
                output += '<div class="divRow ' + tr_class + '" data-i="' + i + '" data-value="' + data[i][fieldValue] + '">';
                output += output_tds;
                output += '</div>';
            }
            output += '</div>';
            ...
            output += "<div class='divHeader'><div class='divRow'><div class='divCell'>No results.</div></div></div>";
        }
