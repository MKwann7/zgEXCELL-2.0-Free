...
$this->CurrentPage->BodyId            = "video-library-page";
$this->CurrentPage->BodyClasses       = ["admin-page", "video-library-page", "two-columns", "left-side-column"];
$this->CurrentPage->Meta->Title       = "Video Library | " . $this->app->objCustomPlatform->getPortalDomain();
...
$this->CurrentPage->SnipIt->Title     = "Video Library";
...
<div class="breadCrumbs">
    <div class="breadCrumbsInner">
        ...
        <span class="breadCrumbPage">Video Library</span>
    </div>
</div>
