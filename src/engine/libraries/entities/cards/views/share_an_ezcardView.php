...
$this->CurrentPage->BodyId            = "share-an-ezcard-page";
$this->CurrentPage->BodyClasses       = ["admin-page", "share-an-ezcard-page", "two-columns", "left-side-column"];
$this->CurrentPage->Meta->Title       = "Share An EZcard | " . $this->app->objCustomPlatform->getPortalDomain();
...
$this->CurrentPage->SnipIt->Title     = "Share An EZcard";
...
<div class="breadCrumbs">
    <div class="breadCrumbsInner">
        ...
        <span class="breadCrumbPage">Share An EZcard</span>
    </div>
</div>
