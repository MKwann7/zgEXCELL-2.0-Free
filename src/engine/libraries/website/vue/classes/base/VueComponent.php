...
' . $this->renderDynamicComponentDataAssignmentDataField() . '
            ...
            methods: {
                ...
                {
                    // TODO - Why can\'t we allow this to happen multiple times?    
                ...
                {
                    if (data === null || typeof data.isLoggedIn === "undefined" || typeof data.user === "undefined" || data.isLoggedIn === "inactive") { 
                ...
                checkAuthRoles: function()
                {
                    ...
                    if (this.user !== null && this.user.Roles.length >= 1)
                    {
                        let self = this;
