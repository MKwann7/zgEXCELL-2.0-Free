...
<div id="arc-menu">
        ...
        <div>
            <nav>
                ...
                <ul class="drag">
                    ...
                    <li class="mainLink show <?php if ( $strCurrentPage == "contactus") { ?>current<?php } ?>"><a href="/contact-us/">Contact Us</a></li>
    ...
    </div><a id="dismiss"><img alt="dismiss" src="/website/images/dismiss.png"/></a>
</div>
